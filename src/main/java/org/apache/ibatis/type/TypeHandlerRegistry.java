...
public final class TypeHandlerRegistry {
    ...
    /**
     * 一个 jdbc type 对应一个 TypeHandler 处理器
     */
    private final Map<JdbcType, TypeHandler<?>> JDBC_TYPE_HANDLER_MAP = new EnumMap<>(JdbcType.class);
    /**
     * 一个 javaType 可能对应多个 Typehandler
     */
    private final Map<Type, Map<JdbcType, TypeHandler<?>>> TYPE_HANDLER_MAP = new ConcurrentHashMap<>();
    private final TypeHandler<Object> UNKNOWN_TYPE_HANDLER = new UnknownTypeHandler(this);
    /**
     * 所有的 Class 类型对应的 TypeHandler，可以通过类类型拿到相对应的 TypeHandler
     */
    private final Map<Class<?>, TypeHandler<?>> ALL_TYPE_HANDLERS_MAP = new HashMap<>();

    /**
     * 不同的 JdbcType 对应的 TypeHandler ，构造一个空的
     */
    ...
    /**
     * MyBatis 已经为我们自动注册了很多的 TypeHandler了
     */
    ...
    /**
     * 根据 javaType 判断是否有指定的 TypeHandler 转换器
     *
    ...
    /**
     * 根据 java 类型 和 jdbc 类型判断是否有相对应的转换器
     *
     * @param javaType  java 类型
    ...
    /**
     * 通过具体的 类类型获取对应的 TypeHandler
     *
     * @param type 类型
     * @param <T> 泛型，我们可以通过泛型拿到对应的类型
     * @return
     */
